  ...
  return (
    <section className="mt-[2em] px-[2em]">
      <div className="md:text-center">
        <img src={mainProductImg} alt="a phone image" className="m-auto" />
        ...
        <h2 className="mt-[1em] text-[2em] font-semibold">
          Apple iPhone 14 Pro Max
        </h2>

        <div className="flex items-center gap-[1em] mt-[.5em]">
          <span className="text-3xl font-semibold">$1399</span>
          <span className="text-[1.5em] text-mid-gray line-through">$1499</span>
        </div>

        <div className="flex items-center mt-[1.5em]">
          <p>Select Color: </p>
        ...
        <div className="mt-[2em] flex items-center gap-2">
        ...
        <div className="flex flex-wrap gap-2 justify-center mt-[2em]">
